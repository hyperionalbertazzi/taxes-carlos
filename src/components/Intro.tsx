...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="mb-28 max-w-7xl mx-auto sm:mb-0 scroll-mt-[100rem] flex justify-center"
    >
      <div className="flex flex-col md:flex-row mb-10 mt-4 w-11/12">
        <div className="flex flex-col w-full md:w-3/5 max-md:mb-5">
          ...
          <motion.p
            className="py-4 text-sm xs:text-base xl:text-lg"
            initial={{ opacity: 0, y: 100 }}
            animate={{ opacity: 1, y: 0 }}
          >
